...
\section{Introduction}
    ...
    {\bf Words here about mass dependence: in the simulations, a larger fraction of the mass 
    is ex-situ at increasingly higher mass. Seen in early work by Naab, Oser, etc, and in the 
    Illustris papers. First prediction to compare with is that the accreted/ex-situ fraction is 
    a function of mass.}
