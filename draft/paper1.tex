...
\subsection{Initial Massive Galaxy Sample}
    ...
    {\bf Seems to have the section wrong? Plus, can we consolidate these discussions?}
...
%% ------------------------------------------------------------------------------------ %%        
    ...
    {\bf Still worth thinking about where this belongs and if it can be consolidated with the 
    previous discussion somehow. Maybe better in results?}
    ...
    The right side of Fig~\ref{fig:mass_complete} compares the SMFs of galaxies from 
