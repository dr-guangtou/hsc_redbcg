...
\section{Introduction}
    ...
    According to the ``two-phase'' scenario, minor mergers drive the growth of 
    massive galaxies at late times and can help explain the significant increase
    of $R_{\mathrm{e}}$ (e.g. \citealt{Newman2012, vdWel2014}) as well as the 
    build-up of the outer stellar halos of ETGs (e.g.  \citealt{Szomoru2012, 
    Patel2013}).        
    \update{
    ...
    stellar mass (e.g. \citealt{Lackner2012, Cooper13, Qu2017}).
    According to the recent results from Illustris \footnote{
    \texttt{http://www.illustris-project.org/}} simulation (\citealt{Vogelsberger2014},
    \citealt{Genel2014}), the fraction of the accreted mass increases significantly
    with total stellar mass at \logms{}$>11.0$, and the accreted component starts 
    to dominate the stellar mass budget ($f_{\mathrm{accreted}}>0.5$) at 
    \logms{}$>11.5$ (\citealt{RodriguezGomez2016}).
    }
    ...
    \song{The following section focuses on the environmental dependence, should move 
    to Paper II, I will replace it with introduction that focus on the mass
    dependence and outskirt profile.}
    
    In addition, according to this two-phase formation scenario, the late time growth 
    of massive ETGs is intrinsically tied to the growth of their host dark matter 
    halos (e.g. \citealt{Leauthaud2012, Behroozi2013, Shankar2013}). 
    ...
    A second prediction of the two-phase formation scenario is therefore that the 
    ...
    HSC wide layer. In this paper, we use this sample to (a)  
    measure profiles for galaxies out to 100 kpc reliably with the HSC data and (b) examine the implications 
    for the stellar mass function when the outer parts of galaxies are accounted for (c) look at 
    trends in outer envelope properties as a function of stellar mass. In a second paper in this series, we 
