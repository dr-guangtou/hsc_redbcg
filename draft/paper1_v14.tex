...
%% ------------------------------------------------------------------------------------ %% 
    ...
    The elliptical profiles of massive galaxies have not been carefully studied 
    out to large radius except for few works using either image stacking method
    (e.g. \citealt{Tal2011, dSouza2015}) or small sample of nearby galaxies 
    (e.g. \citealt{Spavone2017}). 
    }
