...
\title{First Detection of the Enviromental Dependence of the Masses, Sizes, and Structures of Massive Galaxies }
...
%% ------------------------------------------------------------------------------------ %% 
  \begin{figure*}[t!]
      \centering 
      \includegraphics[width=16.0cm]{fig/redbcg_m100_m10_compare}
