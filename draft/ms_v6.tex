...
\subsection{Massive Central Galaxies from Low and High Mass Halos}
    ...
    % of M\mathrm{halo} (halo mass defined as 200 time background) to each cluster. 
    % 3) we then need to estimate the cluster radius R\mathrm{halo} (or R200b, same thing). 
    ...
    % 4) Now for every cluster you have R\mathrm{halo}. And you define the low halo mass central
