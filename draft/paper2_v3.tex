...
%% ------------------------------------------------------------------------------------ %%     
    ...
    \begin{itemize}
        ...
        \item Finally, the differences between the two sets of profiles becomes 
            ...
            This trend has potentially interesting implications 
            
            \alexie{can we explain in one phrase?} that will be investigated in follow-up work. 
...
%% ------------------------------------------------------------------------------------ %% 
\section{E. Stellar Mass Curve-of-Growth for Massive Central Galaxies} 
	\label{app:cog}
%% ------------------------------------------------------------------------------------ %% 


%% ------------------------------------------------------------------------------------ %% 
\section{F. Comparison of \mden{} profiles using \mstar{} from the GAMA survey}
    \label{app:gama} 
