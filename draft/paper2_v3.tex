...
\subsection{The Role of Environment in the ``Two--Phase'' Formation of 
    ...
    scenario for massive central galaxies in a hierarchical universe. 
    ...
    After the star formation was quenched, a more gradual second phase is dominated 
    by non-dissipative mergers of satellite galaxies. 
    Since dry minor mergers can effectively deposit \textit{ex situ} stars in the 
    ...
    When short dynamical friction time is favored (e.g. \citealt{Newman2012}), 
