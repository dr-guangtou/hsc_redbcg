...
%% ------------------------------------------------------------------------------------ %% 
    ...
    elliptical aperture. 
    The 10 kpc and 100 kpc here refer to the radius along the major aixs of the 
    elliptical isophote. 
...
\subsection{Stellar Masses from SED Fitting}
    ...
    measurement and it certaintly underestimates the true flux errors of bright 
    galaxies.  
