...
\subsubsection{General Trends and Comparison with Previous Work}
    ...
    shallow images from the Carnegie-Irvine Galaxy Survey (CGS, \citealt{CGS1}).  
    ...
    than our HSC ones.  
    Our \mden{} profiles show good agreement with the \citet{Huang2013a} sample in the radial range of overlap (out to 50 kpc). CGS images are deeper than SDSS images in the $r$-band, but the median 
