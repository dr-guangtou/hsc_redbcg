...
%% ------------------------------------------------------------------------------------ %% 
 ...
 %   $0.3 < z < 0.5$ using ${\sim} 100$ deg$^2$ of data from the HSC wide layer. 
    ...
    hints a kinematically separated ICL component (e.g. 
    ...
    ICL component share a smooth and continuous distribution. 
    ...
    % Burke2015}). 
    % The virgo cluster is a good  local analog of the typical galaxy in our sample. 
    ...
    % Therefore, it is highly unlikely that out main results are driven by the ICL 
    % component. 
...
%% ------------------------------------------------------------------------------------ %% 
    ...
    \begin{itemize} 
        ...
        \item \textbf{The stellar mass within 100 kpc} 
            ...
            $\times R_{\mathrm{e}}$. 
            We show in \S~\ref{ssec:mtotal} that most of the \mstar{} for 
...
\subsubsection{General Trends and Comparison with Previous Work}
    ...
    resampling method. 
    And it is worth pointing out again that our sample is not complete in the lowest 
    \mtot{} bin, although there is no reason to believe the median \mden{} profile
    ...
    Most previous studies have often focused on surface brightness profiles instead 
    ...
    The superb resolution of the \textit{HST}/ACS image allows \citet{Patel2013} to 
...
%% ------------------------------------------------------------------------------------ %% 
    ...
    So far, we have focused only on 1-D \mden{} profiles. 
	...
	\mstar{}, and 
	b) the ellipticity of the stellar halo is anti-correlated with the slope of 
	\mden{}.
    ...
    larger radii, but there does not appear to be an significant \mstar{} dependence 
...
\subsection{The Formation of Massive Galaxies and the Assembly of Their Outer Halos}
    ...
    halos. 
    Hence, in principle, these results help explain the trend that we see. 
    ...
    HuangMandelbaum2016}). 
    This alignment signal is found to be stronger for more massive galaxies 
    (e.g. \citealt{Hirata2007}).
...
\subsection{Aperture Masses as Proxies of the \textit{In situ} and Accreted Stars}
    ...
    apertures are worth exploring as proxies of the \textit{ex situ} fraction. 
    ...
    simple aperture masses may be used to trace \textit{ex situ} fractions. 
   ...
   \begin{enumerate}
        ...
        \item The inner component of $z{\sim} 0$ ellipticals from the 2-D 
            ...
            \citet{Huang2013b} showed that this inner component is structurally 
...
\section{Summary and Conclusions}
    ...
    \begin{enumerate}
        ...
        \item We show that the \mden{} profiles of massive galaxies are relatively
            ...
            However, there is a large but continuous scatter in outer profiles of 
            massive galaxies. 
