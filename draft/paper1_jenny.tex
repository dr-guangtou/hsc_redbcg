...
\subsection{Stellar Halo and Intra-cluster Light}     
    ...
    More importantly, he majority of massive galaxies in our samples are not considered 
    as the BCG of a cluster (\mhalo{}$\simgt 10^{14}M_{\star}$). 
    Even for BCGs in the \rbcg{} samples, only small fraction of them belong to very 
    massive clusters where strong evidence of photometric ICL component is 
    ...
    Therefore, it is highly unlikely the main results are driven by the ICL component.
