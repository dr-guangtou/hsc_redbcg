...
\subsubsection{General Trends and Comparison with Previous Work}
    ...
    Overall, the structures of massive galaxies are \emph{clearly not self-similar}
    out to 100 kpc. 
    ...
    The right panel of Fig~\ref{fig:avg_prof} compares our results with previous 
    works. 
