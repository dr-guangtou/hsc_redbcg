...
\subsection{Impact of Missing Light on the Galaxy Stellar Mass Function}
    ...
    Overall, this illustrates again that our 1-D approach has certain advantages 
    over the 2-D modeling method and in principle, should capture the majority of 
    the total \mstar{}.
...
%% ------------------------------------------------------------------------------------ %% 
	The 1-D \mden{} profiles are extracted using single band image and the flux-weighted 
	shape of the isophote.  
	From the HSC images of these massive 
