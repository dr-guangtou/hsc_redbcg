...
%% ------------------------------------------------------------------------------------ %%     
    ...
    ``total'' \mstar{} can have a large impact at the high-mass end.  
...
\subsubsection{General Trends and Comparison with Previous Work}
    ...
    of massive galaxy due to several technical issues (e.g. 
    \citealt{Capaccioli2015, Iodice2016, Iodice2017, Spavone2017, Mihos2017})
    
    Although it is relative easier to reach to the very outskirt of massive galaxy 
    in the nearby universe, the small volume limits the number of available 
    ...
    study the structure of massive galaxies in their outskirts. 
