...
%% ------------------------------------------------------------------------------------ %% 
	...
	Left of Fig \ref{fig:ell_color} shows the ellipticity profiles of HSC massive 
	galaxies and highlight the median profiles for the same three \mtot{} bins used 
