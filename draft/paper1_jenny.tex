...
%% ------------------------------------------------------------------------------------ %% 
  \begin{figure}
      ...
      \caption{              
          \textbf{Top:} Difference between \mcmodel{} and \mtot{} for massive
      	  galaxies (grey dots).
          ...
          \textbf{Middle:} Difference between \mmax{} and \mtot{} in the same format. 
          The average difference is small (0.02 dex) and does not show 
          clear mass--dependence. 
          \textbf{Bottom:} Difference between the \mtot{} and \mgama{} in the same
          format.  
          Here \mgama{} is based on single-\ser{} model derived from SDSS images. 
          }
      \label{fig:mass_diff}
  \end{figure}
