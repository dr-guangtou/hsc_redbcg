...
%% ------------------------------------------------------------------------------------ %% 
    ...
    growth, it is time to confront their predictions with additional observations using 
    local galaxy mass profiles. 
    Some progress has been made. 
    One-dimensional analysis has shown that a \ser{} law well-describes the surface 
    brightness (or stellar mass density) profiles of most nearby massive elliptical 
    galaxies (e.g. \citealt{Kormendy2009}; except for the most central region), with 
    the \ser{} index increasing with total luminosity (e.g. \citealt{Graham2013}).
	But, the situation may be more complicated, with a suggestion from 
    ...
    the small area of deeper imaging. 
    }
