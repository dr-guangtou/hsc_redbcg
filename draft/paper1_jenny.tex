...
%    \label{ssec:mass_central}
    ...
    sample are very likely to be the central galaxies of 
    
     very high mass end, and given that we have rejected satellites in \redm{} 
    clusters, any further satellite contamination can be neglected for the purpose of 
    this work
    .
    %% Saved as "dr1_nonbcg_use_sed5b.fits"
%% ------------------------------------------------------------------------------------ %% 
