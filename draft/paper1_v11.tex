...
\subsubsection{General Trends and Comparison with Previous Work}
    ...
    uniform properties in the inner region. \jenny{if we introduce this jargon we need
    to define it at the 1-3 sentence level. Do we need it? we are not resolving cores, right?}
...
%% ------------------------------------------------------------------------------------ %% 
	...
	isophote free. 
	By applying the $i$-band isophotes to images of other bands in the 
	forced-photometry way \jenny{not sure what this means?}, we can also measure the color profiles too. 
