...
\section{Sample Selection and Data Reduction}
    ...
    redshift or reliable ``red-sequence'' photometric redshift at $0.3<z<0.5$. 
    ...
    kpc of massive galaxies, and can safely ignore any structural evolution. 
    ...
    subtraction. 
    We measure the average \m2l{} of these galaxies 
    Using the five-band forced \cmodel{} magnitudes from \texttt{hscPipe}, we 
    measure  of the galaxy via SED fitting. 
...
%% ------------------------------------------------------------------------------------ %% 
    Motivated by the two-phase formation scenario, we focus on \mstar{} within two 
