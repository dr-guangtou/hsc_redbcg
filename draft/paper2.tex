...
\section{Results}
    ...
    in the outer haloes.  
    In Paper~1, we explore the \mstar{}-dependence of the stellar halos in massive 
...
%% ------------------------------------------------------------------------------------ %%     
    ...
    against choices of \mtot{} bins, $\lambda$ cut, and redshift range. 
    ...
    massive central galaxies in more massive halos host much more prominent outer 
    stellar halo. 
